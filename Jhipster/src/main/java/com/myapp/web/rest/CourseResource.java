...
import com.myapp.domain.Course;
...
/**
 * REST controller for managing {@link com.myapp.domain.Course}.
 */
@RestController
@CrossOrigin("*")
@RequestMapping("/api")
        ...
        Optional<Course> result = courseRepository
            ...
            .map(
                existingCourse -> {
                    ...
                    if (course.getCurrentsize() != null) {
                        existingCourse.setCurrentsize(course.getCurrentsize());
                    }
